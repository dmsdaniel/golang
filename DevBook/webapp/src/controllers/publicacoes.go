...
func CriarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	var publicacaoResponse modelos.Publicacao
	if erro = json.NewDecoder(response.Body).Decode(&publicacaoResponse); erro != nil {
	...
	respostas.JSON(w, response.StatusCode, publicacaoResponse)
