...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioId {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel atualizar uma publicacao que não seja sua."))
		return
	}
...
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioId {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel deletar uma publicacao que não seja sua."))
		return
	}
